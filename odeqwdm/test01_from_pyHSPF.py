...
import os
os.chdir('C:\\Users\\kbranna\\source\\repos\\PyHSPF\\examples\\tests\\data')
...
#messagepath = '{}\\hspf\\core\\hspfmsg.wdm'.format(pyhspfdirectory)
messagepath = 'C:\\Users\\kbranna\\source\\repos\\odeqwdm\\odeqwdm\\hspfmsg.wdm'
...
wdm.create_dataset('test.wdm', 133, attributes)
